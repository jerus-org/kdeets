...
- deps: update dependency toolkit to v7(pr [#229])
- deps: lock file maintenance(pr [#224])
- deps: update rust crate clap to 4.6.6(pr [#225])
- deps: update rust crate log to 0.4.34(pr [#226])
- deps: update rust crate rustls to 0.23.43(pr [#227])
- deps: update rust crate thiserror to 2.0.20(pr [#228])
...
- deps: lock file maintenance(pr [#234])
- deps: update rust crate clap to 4.6.7(pr [#235])
...
- deps: update rust crate trycmd to 1.2.1(pr [#220])
- deps: update rust crate webpki-roots to 1.0.9(pr [#221])
...
- deps: update rust crate webpki-roots to 1.0.7(pr [#201])
- deps: update rust crate reqwest to 0.13.4(pr [#204])
- deps: update rust crate rustls to 0.23.40(pr [#205])
- deps: update rust crate tame-index to 0.26.3(pr [#206])
- deps: update rust crate forestry to 1.11.0(pr [#207])
- deps: update rust crate log to 0.4.32(pr [#209])
- deps: update dependency toolkit to v6.5.0(pr [#213])
- deps: update rust crate log to 0.4.33(pr [#210])
- deps: update rust crate rustls to 0.23.41(pr [#211])
- deps: update rust crate webpki-roots to 1.0.8(pr [#212])
- deps: update rust crate env_logger to 0.11.11(pr [#214])
...
- deps: update rust crate tempfile to 3.27.0(pr [#190])
- deps: update rust crate trycmd to 1.2.0(pr [#191])
- remove jq from tools verification(pr [#194])
...
- deps: update rust crate clap to 4.5.54(pr [#161])
- deps: update rust crate smol_str to 0.3.5(pr [#162])
...
- Dependencies: bump time from 0.3.44 to 0.3.47 in the cargo group across 1 directory(pr [#167])

## [0.1.27] - 2025-11-28

### Fixed

- deps: update rust crate clap to 4.5.53(pr [#148])
- deps: update rust crate trycmd to 0.15.11(pr [#149])
- deps: update dependency toolkit to v2.16.0(pr [#150])
- deps: update rust crate tame-index to 0.25.0(pr [#151])
...
- deps: update rust crate tame-index to 0.24.1(pr [#147])
...
- deps: update rust crate log to 0.4.28(pr [#139])
- deps: update rust crate semver to 1.0.27(pr [#140])
- deps: update rust crate tempfile to 3.23.0(pr [#141])
...
- deps: update rust crate clap-verbosity-flag to 3.0.4(pr [#129])
- deps: update rust crate thiserror to 2.0.16(pr [#130])
- deps: update rust crate trycmd to 0.15.10(pr [#131])
- deps: update dependency toolkit to v2.12.1(pr [#132])
- deps: update rust crate rstest to 0.26.1(pr [#133])
- deps: update rust crate tempfile to 3.21.0(pr [#135])
- deps: update rust crate tame-index to 0.23.0(pr [#134])
...
- Dependencies: update rust crate tame-index to 0.22.0(pr [#124])
- Dependencies: update rust crate tempfile to 3.20.0(pr [#125])
...
[#129]: https://github.com/jerus-org/kdeets/pull/129
[#130]: https://github.com/jerus-org/kdeets/pull/130
[#131]: https://github.com/jerus-org/kdeets/pull/131
[#132]: https://github.com/jerus-org/kdeets/pull/132
[#133]: https://github.com/jerus-org/kdeets/pull/133
...
[#139]: https://github.com/jerus-org/kdeets/pull/139
...
[#147]: https://github.com/jerus-org/kdeets/pull/147
[#148]: https://github.com/jerus-org/kdeets/pull/148
[#149]: https://github.com/jerus-org/kdeets/pull/149
[#150]: https://github.com/jerus-org/kdeets/pull/150
[#151]: https://github.com/jerus-org/kdeets/pull/151
[#156]: https://github.com/jerus-org/kdeets/pull/156
...
[#160]: https://github.com/jerus-org/kdeets/pull/160
[#161]: https://github.com/jerus-org/kdeets/pull/161
...
[#190]: https://github.com/jerus-org/kdeets/pull/190
[#191]: https://github.com/jerus-org/kdeets/pull/191
...
[#201]: https://github.com/jerus-org/kdeets/pull/201
[#204]: https://github.com/jerus-org/kdeets/pull/204
...
[#209]: https://github.com/jerus-org/kdeets/pull/209
[#213]: https://github.com/jerus-org/kdeets/pull/213
[#210]: https://github.com/jerus-org/kdeets/pull/210
[#211]: https://github.com/jerus-org/kdeets/pull/211
...
[#220]: https://github.com/jerus-org/kdeets/pull/220
[#221]: https://github.com/jerus-org/kdeets/pull/221
[#223]: https://github.com/jerus-org/kdeets/pull/223
[#229]: https://github.com/jerus-org/kdeets/pull/229
[#224]: https://github.com/jerus-org/kdeets/pull/224
[#225]: https://github.com/jerus-org/kdeets/pull/225
[#226]: https://github.com/jerus-org/kdeets/pull/226
...
[#234]: https://github.com/jerus-org/kdeets/pull/234
[#235]: https://github.com/jerus-org/kdeets/pull/235
